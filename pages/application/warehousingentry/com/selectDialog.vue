                        ...
                        <u-radio v-for="(item, index) in list" :key="index" :name="item.id" :disabled="item.disabled">
                            <view class="flex-between flex-c item">
                                <view class="flex-one" v-for="(itemColumn, index) in column" :key="index">
                                    ...
                                    <view class="dept-name" v-if="itemColumn.component">
                                        <dc-view :value="item[itemColumn.prop]" :objectName="itemColumn.objectName"
                                    /></view>
                                    <view class="dept-name" v-else>{{ item[itemColumn.prop] }}</view>
                                </view>
                            </view>
                        </u-radio>
                    </u-radio-group>

<template>
    <view class="navbar-wapper">
        <view
            class="u-navbar"
            :style="[navbarStyle]"
            :class="{ 'u-navbar-fixed': isFixed && !isPC, 'u-border-bottom': borderBottom }"
        >
            <view class="u-status-bar" :style="{ height: statusBarHeight + 'px' }"></view>
            <view class="u-navbar-inner" :style="[navbarInnerStyle]">
                <view class="u-back-wrap" v-if="isBack" @tap="goBack">
                    <view class="u-icon-wrap">
                        <img src="@/static/images/left-arrow.png" alt="" class="left-icon" />
                    </view>
                    <view class="u-icon-wrap u-back-text u-line-1" v-if="backText" :style="[backTextStyle]">{{
                        backText
                    }}</view>
                </view>
                <view class="u-navbar-content-title" v-if="title" :style="[titleStyle && !isPC]">
                    <view
